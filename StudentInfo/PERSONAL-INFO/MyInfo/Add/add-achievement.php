                    ...
                    <div class="col-md-10">
                        <div class="row field">
                            <div class="col-md-6 fieldcol">
                                ...
                                <input type="text" class="form-control" id="" name="txtAchievement">
                            </div>
                        </div>
                    </div>
                </div>
...
if(isset($_POST['btnSave'])){
    ...
    $Achievements = $_POST['txtAchievement']; 

   $query = "INSERT INTO achievementstbl (StudentID,Achievements) values  ('$x','$Achievements')";
