...
if(isset($_POST['btnSave'])){
    ...
    $txtCertification = $_POST['txtCertification']; 
    $txtYearTaken = $_POST['txtYearTaken']; 

    $query = "UPDATE certificationtbl SET Certification = '$txtCertification', YearTaken ='$txtYearTaken' WHERE CertificationID = '$CertificationID'";
