    ...
    <div class="white-holder">
        ...
        <div class = "container">
            <div class = "col-md-6">
                ...
                <label = "usr" class = "control-label"> Name of Company: </label>
                <p>asdfghjjk</p>
                </div>
                ...
                <div class = "form-group">
                <label = "usr" class = "control-label"> Website: </label>
                <p>asdfghjjk</p>
                </div>
               
                <div class = "form-group">
                 <label = "usr" class = "control-label"> Email Address: </label>
                <p>asdfghjjk</p>
                </div>
                ...
                <div class = "form-group">
                <label = "usr" class = "control-label"> Company Address: </label>
                <p>asdfghjjk</p>
                </div>
            ...
            <div class = "spaces"></div>
                        <a class = "btn btn-danger " id = "save" href= ""><b> Back</b></a>
                        <button class = "btn btn-danger " id = "cancel" name = "btnsave" href= ""><b> Delete Company </b> </button>
</form>
</body>
</html>