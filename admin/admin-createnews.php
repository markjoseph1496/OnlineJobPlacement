...
<body>
    ...
    <div id="container">
        ...
        <!-- End Page Banner -->
        <form action="functions.php" name="addnews" id="addnews" autocomplete="off" method="POST" enctype="multipart/form-data">
            <div id="content">
                <div class="container">
                    <div class="row">
                            ...
                            <div class="col-md-6">
                                <div class="row">
                                    ...
                                    <div class="col-md-9">
                                        <div class = "form-group">
                                            <input type="date" name="newsdate" id="date_news" class="form-control">
                                        </div>
                                    </div>
                                </div>
                                <div class="row">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-9">
                                        <div class="form-group">
                                            <input type="text" name="newslocation" id="newslocation" class="form-control">
                                        </div>
                                    </div>
                                </div>
                                <div class="row">
                                    ...
                                    <div class="col-md-9">
                                        <div class="form-group">
                                            <input type="text" class="form-control" id="newscaption" name="newscaption">
                                        </div>
                                    </div>
                                </div>
                            </div>
                        <div class="col-md-6">
                            ...
                            <div class="row">
                                <div class="col-md-8">
                                    <input id="ProfilePictures" name="ProfilePictures" type="file"
                                           class="file file-loading"
                                    data-allowed-file-extensions='["png", "jpg", "bmp", "gif"]'>
                                </div>
                                <script>
                                    $("#ProfilePictures").fileinput({
                                        showUpload : false
                                    });
                                </script>
                            </div>
                    ...
                    <div class="text-center">
                        <button type="submit" class="btn-system btn-large" id="BtnNewssave" name="BtnNewssave">Save</button>
                        <a href = "admin-createnews.php" class="btn-system btn-large btn-black">Cancel</a>
                    </div>
                </div>
            </div>
        </form>
