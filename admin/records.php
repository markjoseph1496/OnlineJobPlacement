    ...
    <div class="resume_bg">
        ...
        <div class = "container">
            <div class = "col-md-12">
                ...
                <a id="Adduser" href="adduser.php" class=" btn btn-default"> Add User</a>
                <table class = "Applicants" width = "100%" cellpadding = "0">
                 <thead>
                    <tr>
                    <th width = "70%" class = "tabletitle">User's Name </th>
                    <th width = "30%" class = "tabletitle tcenter"> Position</th>
                    </tr> 
                </thead>
                <!--Fields-->
                <tbody>
                    ...
                    ?>
                            <tr>
                                ...
                                <td class = "tcenter"><?php echo $rows[$Position]; ?></td>
                            </tr>
                        <?php
                            }
                        ?>
