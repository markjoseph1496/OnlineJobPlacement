...
<head>
    ...
    <!-- Basic -->
    <title>OJPMS | List of Users</title>
    ...
    <div id="content">
        ...
        <?php
            ...
            <table class="table segment table-hover">
                ...
                $admin_tbl =
                    GSecureSQL::query(
                        "SELECT AdminID, Username, FirstName, LastName, Position, Address, ContactNumber FROM admintbl WHERE Usertype = 'Adviser'",
                        TRUE
                    );
                    ...
                    <tr>
                        ...
                        <td width="10%" class="text-center">
                            ...
                            <button class='btn btn-danger' data-toggle='modal'
                                    data-target='#Delete<?php echo $AdviserID; ?>'><i
