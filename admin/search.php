            ...
            <table class="table segment table-hover">
                ...
                $Studenttbl =
                    GSecureSQL::query(
                        ...
                        FROM studcontactstbl
                        INNER JOIN studentinfotbl ON studcontactstbl.StudentID = studentinfotbl.StudentID
                        WHERE studentinfotbl.StudentID LIKE '%$SearchID%'",
                        TRUE
                    );
                foreach ($Studenttbl as $value){
                $StudentID = $value[0];
                $FirstName = $value[1];
                $LastName = $value[2];
                $Email = $value[3];
                ...
                ?>
                <tr>
                    <td class=tabletitle><?php echo $StudentID; ?></td>
