...
$qry = "SELECT * FROM compeventtbl WHERE  EventID = '$x'";
$result = mysql_query($qry);
    while ($qry = mysql_fetch_array($result)) {
        
        $EventID = $qry['EventID'];
        $EventDatef = $qry['EventDatef'];
        $EventDatet  = $qry['EventDatet'];
        $EventTitle = $qry['EventTitle'];
        ...
        <div class = "container">
            ...
            <div class = "panel-body">
               <table class = "infotable">
                ...
                <td> 
                    <input type = "text" name = "eventtitle" id = "usr" class = "form-control" value="<?php echo $EventTitle; ?>">
                </td>
                </tr>
                ...
                <td> 
                    <input type = "text" name = "location" id = "usr" class = "form-control" value="<?php echo $Location; ?>">
                </td>
                </tr>
               
                <div class = "date">
                <label = "usr" class = "control-label">Event from: </label>
                 <input type = "date" name = "datefrom" id = "date_from" class = "form-control" value="<?php echo $EventDatef; ?>">
                 <div class = "date_to">
                 <label = "usr" class = "control-label">to: </label>
                <input type = "date" name = "dateto" id = "date_to" class = "form-control" value="<?php echo $EventDatet; ?>">
                </div>
                </div>
                ...
                <td> 
                   <input type = "text" class = "form-control" id = "descrip" name = "descrip" value="<?php echo $Description; ?>">
                </td>
                </tr>
...
include('CONNECTION.php');
  ...
  if (isset($_POST['btnsave'])) {
      ...
      $query = "UPDATE compeventtbl SET EventTitle = '$eventtitle', EventDatef = '$datefrom', EventDatet = '$dateto', Location = '$location', Description = '$descrip', Status = '$status' WHERE EventID = '$EventID'";
      $Result = mysql_query($query);
      echo "
        <script type='text/javascript'>
         location.href='Settings_Calendar.php?id=EventEdit';
         </script>
  ";
