    ...
    <nav class="navbar navbar-default navbar-fixed-top navbar-shrink">
     ...
     <div class="white-holder">
       <ul class="nav nav-tabs">
        ...
        <div class = "container">
            <div class = "col-md-12">
                <h3>List of Pending Applicants</h3>
                                        ...
                                        <tbody>
                                            <tr>
                                                ...
                                                <td>
                                                    ...
                                                    <a href=# class='btn btn-danger btnDecline'> <i class='fa fa-times-circle'></i> </a>

                                                    <a data-bb='confirmAcceptRequest' class='bb-alert alert alert-info' style='display: none;' href='acceptapplicant.php?Accepted=1&id=$RID'>
                                                    <a data-bb='confirmDeleteRequest' class='bb-alert alert alert-info' style='display: none;' href='acceptapplicant.php?Accepted=0&id=$RID'> 
                                                </td>
                                                <tr>
                                        </tbody>
                                        ";
