...
<body id="page-top" class="index resume">
    ...
    <div class="resume_bg">
        ...
        <ul class="nav nav-pills" id = "submenu">
            <li class="yellow "><a href="Report.php">Resumelink</a></li>
            <li class="yellow active"><a href="Report_Position.php">Position</a></li>
        </ul>
...
<form method = "POST">
            <div class = "col-md-12">   
                ...
                <h3 class = "panel-title">Reports: Depositories</h3>
                </div>
            <div class = "panel-body">
              ...
              <form method = "POST">
                <div class = "date">
                <label = "usr" class = "control-label">Posting date from: </label>
                ...
                <div class="checkbox" id = "checkbox">
                    ...
                    <label><input type="checkbox" value="">Job Ad Status</label><br>
                    <label><input type="checkbox" value="">Ad Creator</label><br>
                </div>
                <div class="checkbox" id = "checkbox1">
                    <label><input type="checkbox" value="">Total Job Match</label><br>
                    <label><input type="checkbox" value="">Total Job Applications</label><br>
                    <label><input type="checkbox" value="">Total Views</label><br>
                </div>
                <div class = "Export">
